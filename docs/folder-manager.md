...
Press Alt+B or click [respective button](https://i.imgur.com/qsjh9Lh.png) to load Folder Manager in dedicated (internal) tab.
...
Click folder icon or hold Ctrl and click row area next to it to select folder. Note: See [Selecting items](selecting-items.md) for more info about folder selection.
