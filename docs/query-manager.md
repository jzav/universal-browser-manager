...
Click [Query Builder Button](https://i.imgur.com/4JsD0ff.png) to load respective UI.

Click [Saved Queries Button](https://i.imgur.com/Qr2gVEN.png) or press Alt + Q or to load saved queries.
...
Or type nothing else but query keyword in search box (you do not need to start Query Manager first) and press Enter or click [Execute Query Button](https://i.imgur.com/fGiY8N9.png).
